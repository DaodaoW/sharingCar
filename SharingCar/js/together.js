 ...
 startTest();
  ...
  window.onresize = function(){
    ...
    function allTogether(){
       ...
       $.ajax({
            url: 'http://127.0.0.1:1234/together',
            dataType: 'json',
            data:data,
            cache: false,
            timeout: 5000,
          ...
          for(var i=0;i<data.length;i++){
           ...
           layout.innerHTML=layout.innerHTML+"<div class='txt' id='txt'>"+
            ...
            "</div>"+
             ...
             "<textarea oninput='text(this)' onfocus='message(this)'  onBlur='messageEnd(this)' id='m"+data[i].tId+"' class='leaveWords' placeholder='想一起去?留言沟通吧' value=''></textarea>"+
